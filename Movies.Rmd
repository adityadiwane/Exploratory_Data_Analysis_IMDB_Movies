...
```
## Exploratory Data Analysis of IMDB Movies Data-set {.tabset .tabset-fade}
### Synopsis 
...
```{r warning=FALSE, message=FALSE, fig.align='center', out.height = '120%', out.width = '120%'}
library(tibble)
library(DT)
library(knitr)
library(tm)
...
Third part of data cleaning is the currency columns. The “Budget” and “Gross” (revenue) columns for a few countries were not converted to USD while compiling the data. Hence I have done this manually. This cleaning will help us compare these financial columns across movies and countries.
...
```{r warning=FALSE, message=FALSE, fig.align='center',fig.dim=(c(8,8))}
library(plotly)
